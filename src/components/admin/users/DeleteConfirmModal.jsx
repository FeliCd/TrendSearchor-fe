    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <motion.div
        ...
        className="relative w-full max-w-sm overflow-hidden rounded-2xl
          border border-red-500/20 shadow-2xl shadow-red-500/10"
      ...
      >
        ...
        <div className="flex items-center justify-between px-6 py-4 border-b border-gray-800">
          ...
          <button
            onClick={onClose}
            className="p-2 rounded-xl text-white hover:bg-white/5 transition-all duration-200"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        <div className="px-6 py-5">
          <div className="flex items-start gap-3 mb-5">
            <div className="flex-shrink-0 w-10 h-10 rounded-xl bg-red-500/10 border border-red-500/20 flex items-center justify-center mt-0.5">
          ...
          {/* User preview */}
          <div className="mb-5 p-3 rounded-xl border border-gray-800">
            <div className="flex items-center gap-2.5">
              ...
              <div className="min-w-0">
                <p className="text-sm font-semibold text-white truncate">{user?.fullName || user?.mail}</p>
                <p className="text-xs text-gray-400 truncate">{user?.mail}</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="flex-1 px-4 py-2.5 rounded-xl text-sm font-medium text-gray-400
                hover:text-white hover:bg-white/5 border border-gray-800
