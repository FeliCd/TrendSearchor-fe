  ...
  return (
    <>
      ...
      <motion.div initial={{ opacity: 0, scale: 0.92, y: -4 }} animate={{ opacity: 1, scale: 1, y: 0 }}
        ...
        className="fixed w-44 bg-white border border-[#c6c6cd]/60 rounded-xl shadow-xl shadow-black/5 overflow-hidden z-50 py-1"
        style={{ left: 'var(--menu-left, auto)', top: 'var(--menu-top, auto)' }}>
        <button onClick={() => { onView(user); onClose(); }}
          className="w-full flex items-center gap-2.5 px-3 py-2.5 text-xs text-[#0b1c30] hover:bg-[#f8f9ff] transition-colors">
        ...
        <div className="h-px bg-[#c6c6cd]/40 mx-3 my-1" />
