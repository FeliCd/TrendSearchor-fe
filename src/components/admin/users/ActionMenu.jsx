...
export default function ActionMenu({ user, onEdit, onView, onDelete, onClose, position }) {
    useEffect(() => {
    ...
    return (
        <>
            ...
            <motion.div
                ...
                className="w-44 bg-[#161b22] border border-white/10 rounded-xl shadow-2xl shadow-black/40 overflow-hidden z-50 py-1"
            >
