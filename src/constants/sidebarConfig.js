...
const ACADEMIC_CONFIG = {
    ...
    navItems: [
      { to: '/academic', label: 'Dashboard', icon: LayoutDashboard, end: true, comingSoon: true },
      { to: '/academic/search', label: 'Search Papers', icon: Search },
      { to: '/academic/trends', label: 'Trends', icon: TrendingUp, comingSoon: true },
      { to: '/academic/bookmarks', label: 'Bookmarks', icon: BookOpen, comingSoon: true },
...
export const ROLE_SIDEBAR_CONFIG = {
  ...
  RESEARCHER: {
    ...
    navItems: [
      { to: '/researcher', label: 'Dashboard', icon: LayoutDashboard, end: true, comingSoon: true },
      ...
      { to: '/researcher/bookmarks', label: 'Bookmarks', icon: BookOpen, comingSoon: true },
